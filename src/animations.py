            ...
            if provider == 'openai':
                ...
                response = client.models.generate_content(
                    ...
                    config=types.GenerateContentConfig(
                        system_instruction="You are an expert in creating educational video scripts. You always respond in valid JSON format without additional text. IMPORTANT: Match the language of the topic exactly - if the topic is in Spanish, write in Spanish; if in English, write in English.",
